...
const OurOffer = ({ offer }) => {
  const classes = `flex justify-between bg-[#E6EEE6] content-center items-center m-2 mx-auto px-20 py-4  ${offer.className}`;
  ...
  return (
    <div className={classes}>
      <Image
        ...
        className="w-[35%]"
      />
      <div className=" grid gap-1 mt-3 w-1/2">
  ...
  return (
    <main>
      ...
      <section>
        ...
        <div className="w-[90%] grid grid-cols-5 mx-auto gap-5 my-10">
          {products.map((image) => (
            <Image
              src={image.image}
